function [ fset ] = buildFeatureSet_HealthySubjects_RLAnteriorThighAcc(msense)
% Reed Gurchiek, 2018
%
%--------------------------------------------------------------------------
%% initialization
...
fsetf = 'FeatureSet_HealthySubjects_RLAnteriorThighAcc';
...
% otherwise create new
    ...
    % class
    fset.classNames = {'walkFast' 'walkNormal' 'walkSlow' 'runFast' 'runNormal' 'runSlow' 'ascendStairs' 'descendStairs' 'crutchRight' 'crutchLeft' 'squats' 'stand' 'sit' 'staticSquat' 'lie' 'postureTransition' 'walkTransition' 'runTransition' 'crutchTransition'};
    for c = 1:length(fset.classNames)
        fset.class.(fset.classNames{c}).nObservations = 0;
    end

    % feature details
    fset.featureDetails.featureExtractor = 'extractFeatures_RLAnteriorThighAcc';
    fcn = str2func(fset.featureDetails.featureExtractor);
    [~,featureNames] = fcn();
    fset.featureDetails.nFeatures = length(featureNames);
...
% for each dataset
subject = struct();
datasets = {'Healthy Subjects' 'Healthy Subjects v3'};
k = 0;
        ...
        elseif ddir(idir).name(1) == '.' || ddir(idir).name(1) == 'p'; ddir(idir) = [];
            ...
            if strcmp(datasets{d},'Healthy Subjects') && str2double(subject(k).ID(2:end)) < 7
                ...
                trialNames0 = {'Stand'                      {'stand'}                           {''}            {0}                 {''}             {''}               {0};...
                               ...
                               'Treadmill walk slow'        {'walkSlow','walkTransition'}       {'',''}         {4 0}               {'',4}           {''}               {0,''};...
                               'Treadmill walk normal'      {'walkNormal','walkTransition'}     {'',''}         {4 0}               {'',4}           {''}               {0,''};...
                               'Treadmill walk fast'        {'walkFast','walkTransition'}       {'',''}         {4 0}               {'',4}           {''}               {0,''};...
                               'Treadmill run slow'         {'runSlow','runTransition'}         {'',''}         {4 0}               {'',4}           {''}               {0,''};...
                               'Treadmill run comfortable'  {'runNormal','runTransition'}       {'',''}         {4 0}               {'',4}           {''}               {0,''};...
                               'Treadmill run fast'         {'runFast','runTransition'}         {'',''}         {4 0}               {'',4}           {''}               {0,''};...
                               'Lie prone'                  {'lie'}                             {''}            {0}                 {''}             {''}               {0};...
                               'Lie Supine'                 {'lie'}                             {''}            {0}                 {''}             {''}               {0};...
                               'Lie left'                   {'lie'}                             {''}            {0}                 {''}             {''}               {0};...
                               'Lie right'                  {'lie'}                             {''}            {0}                 {''}             {''}               {0};...
                               ...
                               'Crutches left'              {'crutchLeft','crutchTransition'}   {'',''}         {4 0}               {'',4}           {''}               {4,''};...
                               'Crutches right'             {'crutchRight','crutchTransition'}  {'',''}         {4 0}               {'',4}           {''}               {4,''};...
                               'Hallway walk slow'          {'walkSlow','walkTransition'}       {'',''}         {4 0}               {'',4}           {''}               {4,''};...
                               'Hallway walk normal'        {'walkNormal','walkTransition'}     {'',''}         {4 0}               {'',4}           {''}               {4,''};...
                               'Hallway walk fast'          {'walkFast','walkTransition'}       {'',''}         {4 0}               {'',4}           {''}               {4,''}};
